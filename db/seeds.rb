...
user2 = User.create!(
          ...
          password: "1a2s3d4f5g",
          password_confirmation: "1a2s3d4f5g"
        )
...
user1.reviews.create!(
  ...
  description: "Giant, majestic. Easily one of the greatest plant I found online.",
  rating: 5
)
user1.reviews.create!(
  product: Product.find_by!(name: "Enirthelda"),
  description: "Decent plant. Easy to handle and bloom beautiful flowers.",
  rating: 3
)
user1.reviews.create!(
  product: Product.find_by!(name: "Tangle Azolla"),
  description: "Tiny flowers but look nice in garden. Delicious small fruits for bonus.",
  rating: 4
)
user2.reviews.create!(
  product: Product.find_by!(name: "Enirthelda"),
  description: "Hate the barbed-shaped leaves. Makes a thick, unpleasant wax with annoying nuts.",
  rating: 1
)
user2.reviews.create!(
  product: Product.find_by!(name: "Krapliper"),
  description: "Hard to control this plant's growth. This plant makes a sticky and unpleasant goo.",
  rating: 2
)
